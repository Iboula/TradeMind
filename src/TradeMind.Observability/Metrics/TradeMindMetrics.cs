...
public sealed class TradeMindMetrics : ITradeMindMetrics
{
    ...
    private readonly Counter<long> _liveGateDenied = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.LiveGateDenied, "denials");
    private readonly Counter<long> _liveGateBlocked = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.LiveGateBlocked, "blocks");
    private readonly Counter<long> _emergencyStops = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.EmergencyStops, "stops");
    private readonly Counter<long> _quarantinedExecutions = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.QuarantinedExecutions, "executions");
    private readonly Counter<long> _recoveryRuns = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.RecoveryRuns, "runs");
    private readonly Counter<long> _recoveryMismatches = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.RecoveryMismatches, "mismatches");
    private readonly Counter<long> _orphanPositions = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.OrphanPositions, "positions");
    private readonly Counter<long> _distributedLockConflicts = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.DistributedLockConflicts, "conflicts");
    private readonly Counter<long> _executionUnknown = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.ExecutionUnknown, "executions");
    private readonly Counter<long> _riskGuardRejections = TradeMindMeter.Meter.CreateCounter<long>(TelemetryMetricNames.RiskGuardRejections, "rejections");
    ...
    private Counter<long> GetCounter(string name) => name switch
    {
        ...
        TelemetryMetricNames.LiveGateDenied => _liveGateDenied,
        TelemetryMetricNames.LiveGateBlocked => _liveGateBlocked,
        TelemetryMetricNames.EmergencyStops => _emergencyStops,
        TelemetryMetricNames.QuarantinedExecutions => _quarantinedExecutions,
        TelemetryMetricNames.RecoveryRuns => _recoveryRuns,
        TelemetryMetricNames.RecoveryMismatches => _recoveryMismatches,
        TelemetryMetricNames.OrphanPositions => _orphanPositions,
        TelemetryMetricNames.DistributedLockConflicts => _distributedLockConflicts,
        TelemetryMetricNames.ExecutionUnknown => _executionUnknown,
        TelemetryMetricNames.RiskGuardRejections => _riskGuardRejections,
